...
$env = $app->detectEnvironment(function () {
	...
	// Please add your environment in the switch case.
	$environmentname = gethostname () . '@' . dirname (__DIR__);

	switch ($environmentname)
	{
		# Developer envs
		case 'computername.local@/path/to/api':
			return 'local';
		break;

		# Machine envs
		case 'poc-api@/var/www/html/api-poc':
			return 'production';
		break;
